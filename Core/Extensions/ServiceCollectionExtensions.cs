...
{
    public static class ServiceCollectionExtensions // Extensionlar static olmak zorunda
    {
        public static IServiceCollection AddDependencyResolvers
            (this IServiceCollection serviceCollection,ICoreModule[] modules) // İstediğim kadar Resolver'i yani ICoreModule olan şeyleri buraya ekleyebileyim. (Polymorphism)
        {
