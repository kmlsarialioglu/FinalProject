...
namespace Business.ValidationRules.FluentValidation
{
    public class ProductValidator : AbstractValidator<Product> // Product için Validation yarattığımız için Parametre "Product"
    {
        ...
        public ProductValidator()
        {
            ...
            //RuleFor(p => p.Name).Must(StartWithA).WithMessage("Ürün ismi 'A' ile başlamak zorunda"); // Burada olmayan ama benim spesifik yazmak istediğim kurallar için "Must()" methodunu kullanıyoruz,
